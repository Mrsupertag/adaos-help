...
def get_category_content(category):
    articles = {
        "Linux Terminal": [
            ...
            ft.Text("• ls: Lists the contents of a directory.", color="white"),
            ft.Text("• cd: Changes the current directory.", color="white"),
            ft.Text("• pwd: Prints the current working directory.", color="white"),
            ft.Text("• mkdir: Creates a new directory.", color="white"),
            ft.Text("• rm: Removes files or directories.", color="white"),
            ...
            ft.Text("• cp: Copies files or directories.", color="white"),
            ft.Text("• mv: Moves or renames files or directories.", color="white"),
            ft.Text("• touch: Creates an empty file.", color="white"),
            ft.Text("• cat: Displays the contents of a file.", color="white"),
            ft.Text("Advanced Techniques", size=24, weight="bold", color="white"),
            ft.Text("• grep: Searches for text within files.", color="white"),
            ft.Text("• awk: A powerful text-processing language.", color="white"),
            ft.Text("• sed: A stream editor for filtering and transforming text.", color="white"),
            ft.Text("• Bash Scripting: Automate tasks with shell scripts.", color="white"),
            ft.Text("Tips and Tricks", size=24, weight="bold", color="white"),
            ft.Text("• Tab Completion: Use the Tab key to auto-complete commands.", color="white"),
            ft.Text("• Command History: Use Up and Down arrow keys to navigate through commands.", color="white"),
            ft.Text("• Aliases: Create shortcuts for frequently used commands.", color="white"),
            ft.Text("Conclusion", size=24, weight="bold", color="white"),
            ft.Text("The Linux Terminal is an indispensable tool for any Linux user. By mastering the commands and techniques outlined in this article, you'll be well on your way to becoming a more efficient and effective user.", color="white")
        ],
        "File Management": [
            ft.Text("File Management", size=30, weight="bold", color="white"),
            ft.Text("Introduction", size=24, weight="bold", color="white"),
            ft.Text("File management is the process of organizing and maintaining files on your computer. It involves various tasks such as copying, moving, and deleting files.", color="white"),
            ft.Text("Basic File Operations", size=24, weight="bold", color="white"),
            ft.Text("• cp: Copies files or directories.", color="white"),
            ft.Text("• mv: Moves or renames files or directories.", color="white"),
            ft.Text("• rm: Removes files or directories.", color="white"),
            ft.Text("Organizing Files", size=24, weight="bold", color="white"),
            ft.Text("• mkdir: Create new directories.", color="white"),
            ft.Text("• cd: Navigate between directories.", color="white"),
            ft.Text("• ls: List the contents of directories.", color="white"),
            ft.Text("Advanced File Management", size=24, weight="bold", color="white"),
            ft.Text("• rsync: Synchronizes files and directories.", color="white"),
            ft.Text("• find: Searches for files and directories.", color="white"),
            ft.Text("• tar: Creates and extracts compressed archives.", color="white"),
            ft.Text("Tips and Tricks", size=24, weight="bold", color="white"),
            ft.Text("• Use Aliases: Create shortcuts for frequently used commands.", color="white"),
            ft.Text("• Organize by Type: Keep files organized into different folders.", color="white"),
            ft.Text("• Regular Backups: Back up important files.", color="white"),
            ft.Text("Conclusion", size=24, weight="bold", color="white"),
            ft.Text("Effective file management is crucial for keeping your data organized and accessible.", color="white")
        ],
    ...
    return articles.get(category, [ft.Text("Content Not Found", size=24, color="white")])
